        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <a href="view-hotel.php" class="flex flex-col p-2 hover:bg-neutral-100 rounded-lg">
                <div class="square">
                    ...
                    <img src="../images/hotel/0.jpg" alt="hotel"
                        class="gallery-img w-full h-80 object-cover rounded-lg">
                </div>
            ...
            <a href="" class="flex flex-col p-2 hover:bg-neutral-100 rounded-lg">
                <div class="square">
                    <img src="../images/hotel/1.jpg" alt="hotel"
                        class="gallery-img w-full h-80 object-cover rounded-lg">
                </div>
                <div class="flex justify-between mt-2">
            ...
            <a href="" class="flex flex-col p-2 hover:bg-neutral-100 rounded-lg">
                <div class="square">
                    ...
                    <img src="../images/hotel/3.jpg" alt="hotel"
                        class="gallery-img w-full h-80 object-cover rounded-lg">
                </div>
                <div class="flex justify-between mt-2">
            ...
            <a href="" class="flex flex-col p-2 hover:bg-neutral-100 rounded-lg">
                <div class="square">
                    ...
                    <img src="../images/hotel/4.jpg" alt="hotel"
                        class="gallery-img w-full h-80 object-cover rounded-lg">
                </div>
                <div class="flex justify-between mt-2">
            ...
            <a href="" class="flex flex-col p-2 hover:bg-neutral-100 rounded-lg">
                <div class="square">
                    ...
                    <img src="../images/hotel/5.jpg" alt="hotel"
                        class="gallery-img w-full h-80 object-cover rounded-lg">
                </div>
                <div class="flex justify-between mt-2">
            ...
            <a href="" class="flex flex-col p-2 hover:bg-neutral-100 rounded-lg">
                <div class="square">
                    ...
                    <img src="../images/hotel/6.jpg" alt="hotel"
                        class="gallery-img w-full h-80 object-cover rounded-lg">
                </div>
                <div class="flex justify-between mt-2">
