...
?>
    ...
    <section class=" p-6">
        ...
        <h1 class="text-4xl font-bold">Which of these best describes your place</h1>
        <br>
    <?php
    // echo $err;
    ...
    <section class="flex flex-wrap gap-2">       
        <div class=" w-40 grow">
                ...
                <label for="option-house" class="border-2 border-gray-800 rounded-md p-4 cursor-pointer inline-flex w-full h-full hover:bg-zinc-100 peer-checked:bg-gray-300">
        ...
        <div class="w-40 grow">
                ...
                <label for="option-hotel" class="border-2 border-gray-800 rounded-md p-4 cursor-pointer inline-flex w-full h-full hover:bg-zinc-100 peer-checked:bg-gray-300">
                    <div class="flex flex-col justify-start">
        ...
        <div class="w-40 grow">
                ...
                <label for="option-treehouse" class="border-2 border-gray-800 rounded-md p-4 cursor-pointer inline-flex w-full h-full hover:bg-zinc-100 peer-checked:bg-gray-300">
                    <div class="flex flex-col justify-start">
        ...
        <div class="w-40 grow">
                ...
                <label for="option-yacht" class="border-2 border-gray-800 rounded-md p-4 cursor-pointer inline-flex w-full h-full hover:bg-zinc-100 peer-checked:bg-gray-300">
                    <div class="flex flex-col justify-start">
        ...
        <div class="w-40 grow">
                ...
                <label for="option-tent" class="border-2 border-gray-800 rounded-md p-4 cursor-pointer inline-flex w-full h-full hover:bg-zinc-100 peer-checked:bg-gray-300">
                    <div class="flex flex-col justify-start">
