...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content-host="width=device-width, initial-scale=1.0">
...
<main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            ...
            <div class="hidden sm:block">
                <div class="border-b border-gray-200">
                    <nav class="-mb-px flex space-x-8" aria-label="tabs-host">
                        ...
                        <button class="tab-button border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm" data-tab="reservations">
                            Reservations
                        </button>
                    </nav>
                </div>
        ...
        <div id="dashboard" class="tab-content-host mt-6">
        ...
        <div id="listings" class="tab-content-host mt-6 hidden">
            <h2 class="text-lg leading-6 font-medium text-gray-900 mb-4">Your Listings</h2>
        ...
        <div id="reservations" class="tab-content-host mt-6 hidden">
            <h2 class="text-lg leading-6 font-medium text-gray-900 mb-4">Upcoming Reservations</h2>
            <div class="bg-white shadow overflow-hidden sm:rounded-md">
                <ul role="list" class="divide-y divide-gray-200">
                    <li>
                        <a href="#" class="block hover:bg-gray-50">
